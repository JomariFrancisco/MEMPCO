...
export const PORTAL_ACCOUNT_ROLES = ['employee', 'admin', 'superadmin'];

export const PORTAL_ACCOUNT_STATUSES = ['Active', 'Inactive'];
...
export const portalAccountUpdateSchema = z
  ...
  .refine(
    (payload) =>
      !payload.password ||
      (payload.password.length >= 8 && payload.password === payload.confirmPassword),
    {
      message:
