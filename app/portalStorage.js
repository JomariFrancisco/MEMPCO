...
export const CONCERN_TYPES = [
  'Anti Virus Definition Upgrade',
  'Anti Virus Installation',
  'Anti Virus Scan',
  'Assisted PLDT Internet Personnel',
  'ATM Installations',
  'ATM Portal Installation (Mass-Specc)',
  'ATM Servicing',
  'ATM Troubleshooting',
  'ATM Upgrade',
  'Biometric Enrolling Fingerprint',
  'BioMetric Installations',
  'Biometric Picture Update/Upload',
  ...
  'Editing/Updating IT Reports',
  'Encoding/Updating IT Reports',
  'END OF DAY/ Database Terminating Abnormally',
  'Excel',
  ...
  'Hardware Upgrade',
  'ID Printing (Employee)',
  'Infrastructure Inventory Servicing',
  'Internet Connection',
  'Internet Connection Request',
  'Laptop',
  'Laptop Formatting / Factory Reset',
  'Laptop Installations',
  'Laptop Servicing',
  'Laptop Troubleshooting',
  'Laptop Upgrade',
  'MBWin',
  'MBWIN Applications Installation',
  'MBWIN Applications Troubleshooting',
  'MBWIN Applications Upgrade',
  'MBWIN Maintain Teller',
  'MBWIN Others',
  'MBWIN Teller Roles',
  'Mass-specc Voucher ODBC Configuration',
  'MBWIN Voucher Module re-Installation',
  'MBWIN Voucher Module Troubleshooting',
  'Monitor',
  'Network Cabling',
  'Network Connection',
  'Network Installations/Cabling',
  'Network IP Address Inventory',
  'Network Troubleshooting',
  'Network Upgrade',
  'On-Site',
  'Other Dept Help Services',
  'PC Formatting',
  'PC Installations',
  'PC Servicing',
  'PC Troubleshooting',
  ...
  'Printer Reset & Test Print Servicing',
  'Printer Servicing',
  'Printer Software Servicing',
  'Printer Troubleshooting',
  'Remote Assistance (On-Call)',
  'Remote Assistance (Teamviewer)',
  'Server',
  'Server Hardware Installations',
  'Server Hardware Servicing',
  'Server Hardware Troubleshooting',
  'Server Hardware Upgrade',
  'Server Software Installations',
  'Server Software Servicing',
  'Server Software Troubleshooting',
  'Server Software Upgrade',
  'Software Applications Installation',
  'Software Applications Re-activation',
  'Software Applications Troubleshooting',
  'Software Applications Upgrade/Update',
  'Sofware Access/Login Troubleshooting/Server/Cloud/Biometric',
  'Sofware Orientation',
...
export const CATEGORY_TEMPLATES = {
  'Software Support': 'Application/System Name:\nConcern Type:\nError Message:\nAction Already Tried:',
  'Hardware Support': 'Device Type/Model:\nLocation:\nIssue Description:\nUrgency:',
  'Network Support': 'Connection Type:\nAffected Users/Area:\nIssue Description:\nTime Started:',
  'Request Support': 'Request Type:\nPurpose:\nNeeded Date:\nAdditional Details:',
  'Remote Support': 'Remote Tool Available:\nConcern Type:\nUser Available Time:\nIssue Description:',
  'User Account Management': 'System/Application:\nUsername/Employee ID:\nRequested Access/Issue:\nApprover:',
  '2nd Tier Support': 'Issue Summary:\nPrevious Action Taken:\nEscalation Reason:\nImpact:',
  '3rd Tier Support': 'System/Server Involved:\nCritical Impact:\nLogs/Error:\nEscalation Details:',
  Desktop: 'Desktop Asset/Unit Name:\nIssue Description:\nOffice Location:',
  Laptop: 'Laptop Asset/Model:\nIssue Description:\nOffice Location:',
};
